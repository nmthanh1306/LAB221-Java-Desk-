...
public class GameController {
    ...
    private Thread elapse = ThreadElapse();
    private final GameForm g;
    ...
    public GameController() {
        g = new GameForm();
        g.setLocationRelativeTo(null); // FrameForm to middle screen 
        g.setVisible(true);
...
//            btn.setMargin(new Insets(MARGIN_BUTTON, MARGIN_BUTTON, MARGIN_BUTTON, MARGIN_BUTTON));
    ...
    public java.util.List<Integer> randomNumber(int size) {
    ...
    public boolean checkShuffle(java.util.List<Integer> listNumber) {
        ...
        if (size % 2 == 1) {
            ...
            //couunt chan size chan posemti hang le --> k win
            //count le size chan posemti hang le --> k win/win
        }
    }
